...
public class main {
    public static void main(String[] args) {
        ...
        Carro gol = new Carro("Gol 1.0", "Wolks", 2012, 200, 1200.0);
        Carro unoDeEscadaBoTeto = new Carro("Fiat", "Uno 1.2", 2006, 250, 1600.0);
        Carro ferrari = new Carro("Ferrari", "458 3.0 V8", 2016, 600, 900.0);
